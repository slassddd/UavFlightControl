...
plot(FlightLog_Original.Filter.time_cal,FlightLog_Original.Filter.algo_NAV_alt,'r--');hold on;
%             ylim([-15,100])
...
plot(FlightLog_Original.Filter.time_cal,FlightLog_Original.Filter.algo_NAV_Vd,'b-');hold on;
