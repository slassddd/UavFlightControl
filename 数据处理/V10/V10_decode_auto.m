...
% example: V10Log = V10_decode_auto('log_1.bin-1167365.mat')
% computer name: DESKTOP-QLU0EFU
% generate date: 27-Jan-2021
% Matlab version: 9.9.0.1467703 (R2020b)
% protocol file: V10_v20210113_1647.txt
% data file: log_1.bin-1167365.mat
...
V10Log.ALD1.mode = ALD1(:,6);                                    %   4. | mode    | mode                           | [U8]  | [12:12]   | 
V10Log.ALD1.palne_mode = ALD1(:,7);                              %   5. | plmod   | palne_mode                     | [U8]  | [12:12]   | 
V10Log.ALD1.flightTaskMode = ALD1(:,8);                          %   6. | fmod    | flightTaskMode                 | [U8]  | [12:12]   | 
V10Log.ALD1.PathMode = ALD1(:,9);                                %   7. | ptmod   | PathMode                       | [U8]  | [12:12]   | 
V10Log.ALD1.limit_pos_up = ALD1(:,10);                           %   8. | posup   | limit_pos_up                   | [U8]  | [12:12]   | 
V10Log.ALD1.throttle_upper = ALD1(:,11);                         %   9. | thup    | throttle_upper                 | [U8]  | [12:12]   | 
V10Log.ALD1.throttle_lower = ALD1(:,12);                         %  10. | thlo    | throttle_lower                 | [U8]  | [12:12]   | 
V10Log.ALD1.Sum = ALD1(:,13);                                    %  11. | Sum     | Sum                            | [U8]  | [12:12]   | 
catch ME
	disp(ME.message);
end
%% ALD2
