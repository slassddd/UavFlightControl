...
TASK_SET.PathPlanner.maxRolld = 50; % 最大滚转 [deg]
...
TASK_SET.PathPlanner.low_battery_alarm_set = 22; % 低电量报警百分比
TASK_SET.PathPlanner.severe_low_battery_alarm_set = 11; % 严重低电量报警百分比
...
TASK_SET.PathPlanner.vertDist_verticalMove = 5; % 垂直运动模式参数：高度阈值
