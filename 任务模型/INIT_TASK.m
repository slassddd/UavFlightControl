...
TASK_SET.PathPlanner.turnR = 70; % 盘旋半径 [m]
...
TASK_SET.PathPlanner.enterStallGroundSpeed = 5; % 判断进入失速的地速阈值
TASK_SET.PathPlanner.enterStallTimeSec = 1; % 确认进入失速状态所需的持续失速时间sec
TASK_SET.PathPlanner.midHeight_TakeOffandLand = 10; % 起飞着陆中间暂留点
TASK_SET.PathPlanner.finalHeight_TakeOff = 60;
TASK_SET.PathPlanner.maxClimbSpeed_nearGround_TakeOffandLand= 0.6; % 起飞着陆近地截断最大垂速
TASK_SET.PathPlanner.maxClimbSpeed_normal_TakeOffandLand= 3; % 起飞着陆近地截断最大垂速
...
TASK_SET.PathPlanner.heightThreshold_LandSuccess = 0.05; % 
